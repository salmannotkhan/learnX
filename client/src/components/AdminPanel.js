            ...
            <div className="columns is-multiline is-mobile">
              <div className="column is-one-quarter" style={{ marginTop: -30 }}>
                <div className="card">
                  ...
                  <div className="card-content">
                    <div className="content">
                      <div className="media-content">
                        <p className="title is-4" style={{ color: "#060325" }}>
                          Trainers
                        </p>
                        <p
                  ...
                  <footer className="card-footer">
                    <Link to="viewtrainers" className="card-footer-item">
                      View
                    </Link>
                  </footer>
                </div>
              ...
              <div className="column is-one-quarter" style={{ marginTop: 50 }}>
                <div className="card">
                  ...
                  <footer className="card-footer">
                    <Link to="viewtrainees" className="card-footer-item">
                      View
                    </Link>
                  </footer>
                </div>
              ...
              <div className="column is-one-quarter" style={{ marginTop: -30 }}>
                <div className="card">
                  ...
                  <footer className="card-footer">
                    <Link to="viewvideos" className="card-footer-item">
                      View
                    </Link>
                  </footer>
                </div>
              ...
              <div className="column is-one-quarter" style={{ marginTop: 50 }}>
                <div className="card">
                  ...
                  <footer className="card-footer">
                    <Link to="viewsubscriptions" className="card-footer-item">
                      View
                    </Link>
                  </footer>
                </div>
